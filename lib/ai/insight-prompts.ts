...
> = {
  briefing:             { label: 'Briefing',             description: "Today's priorities across all your businesses",        scope: 'org',      cacheTtlHours: 48 },
  relationship_radar:   { label: 'Relationship Radar',   description: 'At-risk relationships, gone quiet, flagged',          scope: 'org',      cacheTtlHours: 48 },
  pipeline_pulse:       { label: 'Pipeline Pulse',       description: 'Contracts active, expiring, and lapsed with totals',  scope: 'org',      cacheTtlHours: 48 },
  state_of_play:        { label: 'State of Play',        description: 'Full analysis: revenue, trends, what\'s working',     scope: 'org',      cacheTtlHours: 48 },
  reconnect_list:       { label: 'Reconnect List',       description: 'Businesses not contacted in 60+ days worth a nudge', scope: 'org',      cacheTtlHours: 48 },
  buried_gold:          { label: 'Buried Gold',          description: 'Forgotten commitments and context in old messages',   scope: 'org',      cacheTtlHours: 48 },
  prospecting_targets:  { label: 'Prospecting Targets',  description: 'Warm prospects based on your existing relationships', scope: 'org',      cacheTtlHours: 48 },
  data_health_org:      { label: 'Data Health',          description: 'Missing fields, incomplete records, gaps to fill',    scope: 'org',      cacheTtlHours: 48 },
  call_prep:            { label: 'Call Prep',            description: 'Right-now ready: contacts, history, deal status',     scope: 'business', cacheTtlHours: 12 },
  relationship_story:   { label: 'Relationship Story',   description: 'Full arc: how it started, key moments, where you stand', scope: 'business', cacheTtlHours: 12 },
  outreach_draft:       { label: 'Outreach Draft',       description: 'Personalised re-engagement message in your style',   scope: 'business', cacheTtlHours: 12 },
  what_did_we_agree:    { label: 'What Did We Agree',    description: 'Commitments and promises made in both directions',    scope: 'business', cacheTtlHours: 12 },
  next_best_action:     { label: 'Next Best Action',     description: 'Based on everything, the one thing to do next',      scope: 'business', cacheTtlHours: 12 },
  risk_check:           { label: 'Risk Check',           description: 'Warning signs — silence, unresolved issues, drift',  scope: 'business', cacheTtlHours: 12 },
  full_picture:         { label: 'Full Picture',         description: 'Everything about this business in one place',        scope: 'business', cacheTtlHours: 12 },
  data_health_biz:      { label: 'Data Health',          description: "What's missing or off for this specific business",   scope: 'business', cacheTtlHours: 12 },
  custom:               { label: 'Custom',               description: 'Your custom insight',                                scope: 'org',      cacheTtlHours: 48 },
}
