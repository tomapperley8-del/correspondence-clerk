  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-brand-paper px-4">
      <div className="text-center max-w-md">
        <p className="text-7xl font-bold text-brand-navy mb-4" style={{ fontFamily: 'var(--font-serif)' }}>
          404
        </p>
        <h1 className="text-2xl font-semibold text-brand-dark mb-3" style={{ fontFamily: 'var(--font-serif)' }}>
          Page not found
        </h1>
