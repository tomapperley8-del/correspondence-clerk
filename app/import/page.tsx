...
export default async function ImportPage({ searchParams }: { searchParams: Promise<{ error?: string; detail?: string }> }) {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      <h1 className="font-[Lora,serif] text-2xl font-semibold text-[#1E293B] mb-2">Import emails</h1>
      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-10">
        ...
        <div className="bg-white border border-gray-200 rounded p-6 shadow-[var(--shadow-sm,0_1px_3px_rgba(0,0,0,0.06))] flex flex-col">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h2 className="font-medium text-[#1E293B]">Gmail</h2>
            {gmailConnected && (
          ...
          {gmailConnected ? (
            <Link
              href="/import/gmail"
              className="text-center px-4 py-2 bg-[#2C4A6E] text-white text-sm font-medium hover:bg-[#1E293B] transition-colors"
            >
              Import from Gmail
            </Link>
          ) : (
        ...
        <div className="bg-white border border-gray-200 rounded p-6 shadow-[var(--shadow-sm,0_1px_3px_rgba(0,0,0,0.06))] flex flex-col">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h2 className="font-medium text-[#1E293B]">Outlook</h2>
            {outlookConnected && (
              <span className="ml-auto text-xs px-2 py-0.5 bg-green-50 text-green-700 border border-green-200 rounded">
                Connected
              </span>
      ...
      <div className="border-t border-gray-100 pt-6">
        <p className="text-sm text-gray-500">
          ...
          <Link href="/install-bookmarklet" className="text-[#2C4A6E] hover:underline">
