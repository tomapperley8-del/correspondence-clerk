...
export default function GmailImportPage() {
    ...
    return (
      <div className="max-w-lg mx-auto mt-12 px-4">
        ...
        <div className="bg-white border border-gray-200 rounded p-8 shadow-[var(--shadow-sm,0_1px_3px_rgba(0,0,0,0.06))]">
          <h1 className="font-serif text-2xl font-semibold text-brand-dark mb-2">Connect Gmail</h1>
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <h1 className="font-serif text-2xl font-semibold text-brand-dark mb-1">Import from Gmail</h1>
