...
export default function BusinessError({
  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-lg text-center">
      <h2 className="text-2xl font-bold text-brand-dark mb-3" style={{ fontFamily: 'var(--font-serif)' }}>
        Something went wrong
      </h2>
      <p className="text-gray-600 mb-6">
        This business page couldn&apos;t load. Your correspondence is safe — this is a temporary issue.
      </p>
      {error.digest && (
