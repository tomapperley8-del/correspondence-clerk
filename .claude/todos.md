...
- [x] **P19** — File uploads on business pages: `business_files` table + Supabase Storage bucket `business-files`, server actions (upload/delete/download URL), BusinessFiles component on business page, 10MB per file / 50MB per org cap. Migration ready, needs manual apply + bucket creation. PDF text extraction deferred. (04/04/2026)
